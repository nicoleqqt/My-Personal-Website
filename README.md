# Alexandra Nicole J. Nucos — Personal Website
...
2. Upload **all four files** in this folder to the repository, keeping them in the root (not inside a subfolder).
3. Go to the repo's **Settings → Pages**.
4. Under "Build and deployment," set **Source** to `Deploy from a branch`.
5. Choose the `main` branch and `/ (root)` folder, then click **Save**.
6. Wait a minute or two — GitHub will give you a live link like:
   `https://your-username.github.io/my-portfolio/`

That's it — no build tools, no npm install, just static files.
